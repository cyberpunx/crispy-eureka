...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addButtonHolder: false,           // Where should the add button be placed?
        ...
        uiText: {
            addPrompt: '<span class="glyphicon glyphicon-plus-sign"></span>',         // Text used on the 'add a new form' control.
            removePrompt: '<span class="glyphicon glyphicon-remove-sign"></span>',        // Text used on the 'delete this existing form' control.
        },
    };
})(jQuery);